# canonical-slug-preservation Specification

## Purpose

Preserve canonical record IDs and public URL slugs through intake imports, database reloads, and mutation replay, with uniqueness owned by intake.
