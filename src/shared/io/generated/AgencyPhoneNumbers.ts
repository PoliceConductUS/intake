...
> & {
  spec: Omit<AgencyPhoneNumbersEnvelope["spec"], "records"> & {
    records: Record<
      string,
      { metadata: RecordMetadata; spec: z.infer<typeof AgencyPhoneNumberSpec> }
    >;
  };
};
...
function validateRecord(
  ...
  return result.data as z.infer<typeof AgencyPhoneNumberSpec>;
}
