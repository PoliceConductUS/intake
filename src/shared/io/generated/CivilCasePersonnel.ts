...
function recordSpecSchema(action?: "PUT" | "PATCH" | "POST") {
  return action === "PATCH"
    ? CivilCasePersonnelSpec.partial()
...
> & {
  spec: Omit<CivilCasePersonnelEnvelope["spec"], "records"> & {
    records: Record<
      string,
      { metadata: RecordMetadata; spec: z.infer<typeof CivilCasePersonnelSpec> }
    >;
  };
};
...
function validateRecord(
  ...
  return result.data as z.infer<typeof CivilCasePersonnelSpec>;
}
