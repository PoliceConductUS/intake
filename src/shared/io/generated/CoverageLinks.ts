...
function recordSpecSchema(action?: "PUT" | "PATCH" | "POST") {
  return action === "PATCH" ? CoverageLinkSpec.partial() : CoverageLinkSpec;
}
...
> & {
  spec: Omit<CoverageLinksEnvelope["spec"], "records"> & {
    records: Record<
      string,
      { metadata: RecordMetadata; spec: z.infer<typeof CoverageLinkSpec> }
    >;
  };
};
...
function validateRecord(
  ...
  return result.data as z.infer<typeof CoverageLinkSpec>;
}
