...
function recordSpecSchema(action?: "PUT" | "PATCH" | "POST") {
  return action === "PATCH"
    ? FederalAgencyBranchSpec.partial()
  ...
  spec: Omit<FederalAgencyBranchesEnvelope["spec"], "records"> & {
    records: Record<
      string,
      {
        ...
        spec: z.infer<typeof FederalAgencyBranchSpec>;
      }
    >;
  };
};
...
function validateRecord(
  ...
  return result.data as z.infer<typeof FederalAgencyBranchSpec>;
}
...
> {
  ...
  const records: Record<
    string,
    { metadata: RecordMetadata; spec: z.infer<typeof FederalAgencyBranchSpec> }
  > = {};
