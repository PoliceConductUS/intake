...
describe("planDatabaseMutations", () => {
  ...
  // License and LicenseAction are facade-based (ADR 0016): they produce no
  // transform rows, so plan-time classification no longer plans license /
  // license-action operations. Their create-vs-update decision and emit are
  // owned by the LicenseFacade / LicenseActionFacade and covered by the
  // DataContext facade tests.
});
