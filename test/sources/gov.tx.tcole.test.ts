...
const sheets: Record<string, Array<Record<string, string>>> = {
  Officers: [
    ...
    // malformed: no last name -> skipped
    { PUBLIC_GUID: "1099999", FNAME: "Only", MNAME: "", LNAME: "", SFX: "" },
  ],
  Departments: [
    {
  ...
  Services: [
    ...
    // references an agency not emitted -> skipped (referential integrity)
    {
      PUBLIC_GUID: "1000033",
...
describe("gov.tx.tcole run", () => {
  ...
  it("keys AgencyPersonnel by the identity tuple with license_type=APPOINTMENT", async () => {
    ...
    // the 999999 service is dropped by referential integrity
